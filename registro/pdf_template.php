...
/* Espaciadores para la tabla principal para no solapar el header/footer fijo */
.header-space { height: 90px; } /* 70px header + 20px padding visual */
.footer-space { height: 65px; } /* 50px footer + 15px padding visual */
...
<table style="width: 100%; border: none; border-collapse: collapse;">
  <thead><tr><td style="padding: 0; border: none;"><div class="header-space"></div></td></tr></thead>
...
<div class="content">
  ...
  <tfoot><tr><td style="padding: 0; border: none;"><div class="footer-space"></div></td></tr></tfoot>
</table>

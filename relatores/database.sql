...
CREATE DATABASE IF NOT EXISTS `ddg_otec`
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_unicode_ci;

USE `ddg_otec`;

-- 2. Tabla principal de relatores
--    NOTA: Los datos de transferencia bancaria se almacenan
--    como columnas planas (no JSON) para facilitar consultas
--    e índices futuros.

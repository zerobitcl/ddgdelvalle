...
if ($isAuthed) {
    // La encuesta pública vive en /encuesta/ y guarda ahí; /encuesta.html (raíz) usa datos/ legado.
    $dataFiles = [
        __DIR__ . '/encuesta/datos/resultados.json',
        __DIR__ . '/datos/resultados.json',
    ];
    $list = [];
    $seenIds = [];
